<footer id="colophon" class="site-footer">
                ...
                <div class="container">
                    <div class="subscribe-content">
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-5">
                                <h3 class="subscribe-title">Subscribe Our Email Notification Service !</h3>
                                <p class="subscribe-info">Discover the latest updates and never miss out on important information. Join now for timely insights right to your inbox!.</p>
                            </div>
                            <div class="col-lg-7">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <aside class="widget widget_text img-textwidget">
                                <div class="footer-logo">
                                    <a href="index.html"><img src="assets/img/footer.png" alt="logo"></a>
                                </div>
                                <div class="textwidget widget-text">
                                Start your journey to Japan with Orimi Sasaki Nihon Gakuin! Specializing in student and job visas for Sri Lankans, we pave the way for your educational and career success. Begin your adventure today!                                </div>
                            </aside>
                        ...
                        <div class="col-lg-3 col-md-6">
                            ...
                            <div class="header-btn d-inline-block">
                                <a href="contact.php" class="button-round-secondary">Contact Us</a>
                            </div>
                            </aside>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="bottom-footer">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="copy-right">Copyright &copy; 2024 <a href="https://cryste.online/">Cryste Software </a>. All rights reserved.</div>
                        </div>
                        <div class="col-md-6">
