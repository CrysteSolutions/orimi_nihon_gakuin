                        ...
                        <div class="main-navigation col-lg-9 justify-content-between d-flex align-items-center">
                            <nav id="navigation" class="navigation d-none d-lg-inline-block">
                                <ul>
                                    ...
                                    <li class="menu-item-has-children <?php echo ($current_page == 'about' || $current_page == 'Faq') ? 'current-menu-item' : ''; ?>">
                                    <a href="#">About Us</a>
                                        <ul>
                                            <li>
                                    ...
                                    <li <?php echo ($current_page == 'categories') ? 'class="current-menu-item"' : ''; ?>> 
                                        <a href="categories.php">Visa Details</a>
                                    </li>

                                    <!--  additional heders-->

                                    <li <?php echo ($current_page == 'facility') ? 'class="current-menu-item"' : ''; ?>> 
                                        <a href="facility.php">facility details</a>
                                    </li>

                                    <li <?php echo ($current_page == 'career') ? 'class="current-menu-item"' : ''; ?>> 
                                        <a href="career.php">career details</a>
                                    </li>

                                    <li <?php echo ($current_page == 'feature-course') ? 'class="current-menu-item"' : ''; ?>> 
