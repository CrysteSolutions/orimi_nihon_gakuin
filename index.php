                    ...
                    <div class="row align-items-end">
                        <div class=" banner-left col-md-6">
                            ...
                            <div class="banner-content">
                                ...
                                <div class="banner-text">
                                    <p>Embark on your Japanese journey with Orimi Sasaki Nihon Gakuin! We specialize in student visas for Sri Lankan students and job visas for those aspiring to work in Japan. Let us simplify your path to education and career success in Japan. Start your adventure with us today!</p>
                                </div>
                                <div class="banner-button">
                                    <a href="categories.php" class="button-round-secondary">LEARN MORE</a>
                                </div>
                            </div>
                        </div>
                        <div class=" banner-right col-md-6">
                            <figure class="banner-img">
                                ...
                                <img src="assets/img/pngegg (7).png" alt="">
                            </figure>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-6 ">
                            <div class="about-left-content">
                                <figure class="figure-round-border">
                                    <img src="assets/img/360_F_265237090_Muthvb72m2POYFjyx7F5UCQLh9JdBtKN.jpg" alt="">
                                </figure>
                                <div class="skill-container">
                                    <div class="skill-wrapper">
                                        <h6 class="skill-titile">job availability</h6>
                                        <div class="progress-wrapper">
                                            <div class="ab-progress example" data-progress data-value="92"></div>
                                        </div>
                                    </div>
                                    <div class="skill-wrapper">
                                        <h6 class="skill-titile">Student Visa approval from our agency</h6>
                                        <div class="progress-wrapper">
                                            <div class="ab-progress example" data-progress data-value="98"></div>
                                        </div>
                                    </div>
                                    <div class="skill-wrapper">
                                        <h6 class="skill-titile">Student friendly background</h6>
                                        <div class="progress-wrapper">
                                ...
                                <div class="regarding-us">
                                    <div class="qulifaction-content left-content">
                                        ...
                                        <div class="qulifaction-detail">
                                            <p>
                                            We're Certified Institute for Japanese Visas. As a registered company in Sri Lanka, we specialize in seamless visa services, ensuring your path to Japan is secure and successful.
                                            </p>
                                        </div>
                                    </div>
                                    <div class="qulifaction-content right-content">
                                        ...
                                        <div class="qulifaction-detail">
                                            <p>
                                            Learn Japanese with our certified instructors in every program. We guide you to attain N1 to N5 Japanese language certifications, ensuring linguistic proficiency and cultural integration. Start your linguistic journey with us!
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="about-btn">
                                    <a href="about.php" class="button-round-secondary">MORE ABOUT US</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class=" about-right-content">
                                ...
                                <p class="about-desc">
                                    studying in Japan can offer you not only a top-notch education but also a chance to immerse yourself in a vibrant culture, gain valuable skills, and create lasting memories in a safe and technologically advanced environment.
                                </p>
                                <figure class="figure-round-border">
                                    <img src="assets/img/istockphoto-902966276-612x612.jpg" alt="">
                                </figure>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="service-wrapper">
                        ...
                        <div class="service-content">
                            <div class="section-head">
                                <div class="title-divider"></div>
                                <h2>Student Visa Categories </h2>
                                <div class="service-btn">
                                    <a href="categories.html" class="button-round-primary">MORE DETAILS</a>
                                </div>
                            </div>
                    ...
                    <div class="overlay-wrapper">
                        <div class="row">
                            <div class="col-lg-6 offset-lg-3">
                                <div class="title-divider"></div>
                                <h2 class="section-title">Most Featured Learning Pathways</h2>
                                    ...
                                    <article class="post">
                                        ...
                                        <div class="entry-content">
                                            ...
                                            <div class="author-content">
                                                ...
                                                <h6 class="author-name">University of Tokyo </h6>
                                            </div>
                                    ...
                                    <article class="post">
                                        ...
                                        <div class="entry-content">
                                            ...
                                            <div class="author-content">
                                                ...
                                                <h6 class="author-name">Kyoto University</h6>
                                            </div>
                                            <div class="entry-meta">
                                                <span class="student-number">
                                                    <i aria-hidden="true" class="fas fa-user-friends"></i>
                                    ...
                                    <article class="post">
                                        ...
                                        <div class="entry-content">
                                            ...
                                            <div class="author-content">
                                                ...
                                                <h6 class="author-name">Osaka University</h6>
                                            </div>
                                            <div class="entry-meta">
                                                <span class="student-number">
                                                    <i aria-hidden="true" class="fas fa-user-friends"></i>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <div class="fact-section-head">
                                ...
                                <div class="service-btn">
                                    <a href="https://wa.me/+94788601460" class="button-round-secondary">JOIN US NOW</a>
                                </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 offset-lg-3">
                            ...
                            <p class="feature-section-info text-center">Expert instructors, affordable courses, seamless processes, and a visa guarantee for a top-notch educational experience with us.</p>
                        </div>
                    </div>
                    <div class="feature-wrapper">
                        <div class="feature-type">
                            ...
                            <h4 class="feature-heading">Skilled Teachers</h4>
                            <p class="feature-info">Skilled instructors elevate learning experiences, ensuring excellence in education and Japanese language proficiency. Join us today!</p>
                            <a href="single-page.html" class="right-arrow-link">
                        ...
                        <div class="feature-type">
                            ...
                            <h4 class="feature-heading">Affordable Courses</h4>
                            <p class="feature-info">Discover the perfect balance of quality and affordability in our courses. Accessible education, enriching experiences – enroll affordably for a rewarding learning journey.</p>
                            <a href="single-page.html" class="right-arrow-link">
                                <i aria-hidden="true" class="icon icon-right-arrow"></i>
                            </a>
                        </div>
                        <div class="feature-type">
                            ...
                            <h4 class="feature-heading">Efficient & Flexible</h4>
                            <p class="feature-info">Our crew ensures flexibility, a visa guarantee, and seamless collaboration. Experience an easy partnership with us, ensuring smooth processes for your journey ahead.</p>
                            <a href="single-page.html" class="right-arrow-link">
                                <i aria-hidden="true" class="icon icon-right-arrow"></i>
                            </a>
                        </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-5">
                            <div class="goal-content">
                                ...
                                <p class="goal-info">Committed to the Best Results! Our 100% visa approval rate reflects our dedication to ensuring every application succeeds. Trust in excellence with us</p>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 offset-lg-3">
                            ...
                            <p class="testimonial-section-info text-center">This is the wisdom that Orimi Sasaki Nihon gakuin Created.</p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                ...
                <div class="container">
                    <div class="overlay-wrapper">
                        ...
                        <div class="row">
                            <div class="col-lg-6 offset-lg-3">
                                <div class="title-divider-center"></div>
                                <h2 class="blog-section-title text-center">Checkout Our Blog</h2>
                                <p class="blog-section-info text-center">Subscribe to our Notification service to get Instance Email when new Event going on !!</p>
                            </div>
                        </div>
                        <div class="inner-blog-wrap">
                            <article class="post">
                                ...
                                <div class="entry-content">
                                    <h4>
                                        <a href="single-blog.html">Group Of Students Sharing Their Ideas</a>
                                    </h4>
                                    <p class="blog-info">
                                        Velit beatae cursus mollitia excepturi. Porttitor mus primis nisl voluptate
                                    </p>
                                </div>
                            </article>
                            <article class="post">
                                ...
                                <div class="entry-content">
                                    <h4>
                                        <a href="single-blog.html">Creative Class Library For Students</a>
                                    </h4>
                                    <p class="blog-info">
                                        Velit beatae cursus mollitia excepturi. Porttitor mus primis nisl voluptate
                                    </p>
                            ...
                            <article class="post item-3">
                                ...
                                <div class="entry-content">
                                    <h4>
                                        <a href="single-blog.html">College Seminar “Leadership & Works”</a>
                                    </h4>
                                    <p class="blog-info">
                                        Velit beatae cursus mollitia excepturi. Porttitor mus primis nisl voluptate
                                    </p>
