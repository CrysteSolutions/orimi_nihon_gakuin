...
?>
                ...
                <div class="inner-baner-container" style="background-image: url(assets/img/educator-img12.jpg);">
                    <div class="container">
                        <div class="inner-banner-content">
                            <h1 class="inner-title">Archive</h1>
                        </div>
                    </div>
                </div>
            </section>
                            ...
                            <div class="col-lg-8 primary right-sidebar">
                                <div class="inner-blog-wrap">
                                    ...
                                    <article class="post">
                                        ...
                                        <div class="entry-content">
                                            <h4>
                                                <a href="single-blog.html">12th Batch Student’s Convocational Day</a>
                                            </h4>
                                            <p class="blog-info">
                                                Velit beatae cursus mollitia excepturi. Porttitor mus primis nisl voluptate ornare culpa a class inventore aptent. Curae, excepturi, mauris luctus
                                            </p>
                            ...
                            <div class="col-lg-4 secondary">
                                <div class="sidebar">
                                    <aside class="widget author_widget">
                                        <p class="widget-title-dash-border">About Author</p>
                                            ...
                                            <div class="profile">
                                                ...
                                                <div class="text-content">
                                                    <div class="name-title">
                                                        <h4>
                                                            <a href="single-blog.html">William Wright</a>
                                                        </h4>
                                                    </div>
                                                    <p>
                                    ...
                                    <aside class="widget widget_latest_post widget-post-thumb">
                                        <div class="text-center">
                                            <p class="widget-title-dash-border">Recent Post</p>
                                        </div>
                                        <ul>
                                            <li>
                                                ...
                                                <div class="post-content">
                                                    ...
                                                    <div class="entry-meta">
                                                        <span class="posted-on">
                                                            <a href="single-blog.html">August 17, 2023</a>
                                                        </span>
                                                        <span class="comments-link">
                                                            <a href="single-blog.html">No Comments</a>
                                                        </span>
                                                    </div>
                                                </div>
                                            </li>
                                            <li>
                                                ...
                                                <div class="post-content">
                                                    ...
                                                    <div class="entry-meta">
                                                        <span class="posted-on">
                                                            <a href="single-blog.html">August 1, 2023</a>
                                                        </span>
                                                        <span class="comments-link">
                                                            <a href="single-blog.html">No Comments</a>
                                                        </span>
        ...
        <!-- back to top -->
        <a id="backTotop" href="single-blog.html" class="to-top-icon">
        ...
        <div class="header-search-form">
            <div class="container">
                <div class="header-search-container">
                    ...
                    <a href="single-blog.html" class="search-close">
